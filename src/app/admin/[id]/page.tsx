...
const s: Record<string, CSSProperties> = {
  ...
  backLink: {
    fontSize: 14, color: '#A16207', textDecoration: 'none',
  ...
  card: {
    ...
    borderRadius: 12, padding: '4px 16px', marginBottom: 16, boxShadow: '2px 2px 0 #E5E0DA',
  },
  row: {
    display: 'flex', justifyContent: 'space-between', alignItems: 'center',
    padding: '12px 0', borderBottom: '1px solid #F0EDE8',
  },
  rowLabel: { fontSize: 13, color: '#777777', flexShrink: 0 },
  rowValue: { fontSize: 15, fontWeight: 600, color: '#333333', textAlign: 'right', marginLeft: 16 },
  rowStatus: {
    display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 0',
  },
  statusLabel: { fontSize: 13, color: '#777777' },
  badgeEditable: {
    fontSize: 12, fontWeight: 600, color: '#16A34A', background: '#DCFCE7',
    padding: '3px 10px', borderRadius: 20,
  },
  badgeInvoiced: {
    fontSize: 12, fontWeight: 600, color: '#777777', background: '#F0EDE8',
    padding: '3px 10px', borderRadius: 20,
  },
  sectionTitle: {
    fontSize: 13, fontWeight: 600, color: '#888888', margin: '0 0 8px 4px', letterSpacing: '0.05em',
  },
  divider: { borderTop: '1px solid #F0EDE8' },
  ...
  itemName: { fontSize: 15, color: '#333333', fontWeight: 500, flex: 1 },
  spec: { fontSize: 13, color: '#777777', fontWeight: 400 },
  taxBadge: {
    fontSize: 11, color: '#888888', background: '#F0EDE8',
    padding: '2px 6px', borderRadius: 4, flexShrink: 0,
  },
  priceRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' },
  priceLabel: { fontSize: 13, color: '#777777' },
  lineTotal: { fontSize: 16, fontWeight: 700, color: '#A16207' },
  taxRow: {},
  taxLabel: { fontSize: 12, color: '#888888' },
  totalsCard: {
    background: '#FFFFFF', border: '1px solid #E5E0DA',
    borderRadius: 12, padding: '4px 16px', marginBottom: 16, boxShadow: '2px 2px 0 #E5E0DA',
  },
  ...
  totalLabel: { fontSize: 14, color: '#777777' },
  totalValue: { fontSize: 14, color: '#555555', fontWeight: 500 },
  grandTotalRow: {
    display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '14px 0',
  },
  grandTotalLabel: { fontSize: 15, fontWeight: 700, color: '#333333' },
  grandTotalValue: { fontSize: 20, fontWeight: 700, color: '#A16207' },
}
