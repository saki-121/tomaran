...
const s: Record<string, CSSProperties> = {
  ...
  heading: { fontSize: 22, fontWeight: 700, color: '#111827', margin: '0 0 20px' },
  filterRow: { marginBottom: 16 },
  filterForm: { display: 'flex', gap: 8, flexWrap: 'wrap' },
  select: {
    padding: '8px 12px', border: '1px solid #d1d5db', borderRadius: 8,
    fontSize: 14, color: '#374151', backgroundColor: '#fff', minWidth: 140,
  },
  filterBtn: {
  ...
  summaryTotal: { fontSize: 20, fontWeight: 700, color: '#111827' },
