...
const s: Record<string, CSSProperties> = {
  ...
  heading: { fontSize: 22, fontWeight: 700, color: '#333333', margin: '0 0 20px' },
  filterRow: { marginBottom: 16 },
  filterForm: { display: 'flex', gap: 8, flexWrap: 'wrap' },
  select: {
    padding: '8px 12px', border: '1px solid #D0CAC3', borderRadius: 8,
    fontSize: 14, color: '#333333', backgroundColor: '#FFFFFF', minWidth: 140,
  },
  filterBtn: {
  ...
  summaryCard: {
    ...
    padding: '14px 20px', marginBottom: 20, boxShadow: '2px 2px 0 #E5E0DA',
  },
  summaryLabel: { fontSize: 13, color: '#777777' },
  summaryTotal: { fontSize: 20, fontWeight: 700, color: '#A16207' },
  section: { marginBottom: 24 },
  label: { fontSize: 12, fontWeight: 600, color: '#888888', letterSpacing: '0.05em', margin: '0 0 8px' },
  empty: { fontSize: 14, color: '#888888', textAlign: 'center', padding: '24px 0', margin: 0 },
  list: { listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 8 },
  details: { borderTop: '1px solid #E5E0DA', paddingTop: 4 },
  summary: {
    display: 'flex', justifyContent: 'space-between', alignItems: 'center',
    padding: '10px 0', fontSize: 13, fontWeight: 600, color: '#777777',
    cursor: 'pointer', listStyle: 'none', userSelect: 'none',
  },
  arrow: { fontSize: 10, color: '#888888' },
  lineSupport: {
    display: 'flex',
    alignItems: 'center',
    gap: 12,
...
const card: Record<string, CSSProperties> = {
  ...
  company: { fontSize: 15, fontWeight: 600, color: '#333333' },
  site: { fontSize: 13, color: '#777777' },
  date: { fontSize: 12, color: '#888888' },
  right: { display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 4, flexShrink: 0 },
  total: { fontSize: 16, fontWeight: 700, color: '#A16207' },
  badgeEditable: {
    fontSize: 11, fontWeight: 600, color: '#16A34A', background: '#DCFCE7',
    padding: '2px 8px', borderRadius: 20,
  },
  badgeInvoiced: {
    fontSize: 11, fontWeight: 600, color: '#777777', background: '#F0EDE8',
    padding: '2px 8px', borderRadius: 20,
  },
}
